...
- Preserve source URLs and `last_verified` dates.
- Run `python scripts/validate_repository.py` after structural edits.
- Do not include patient-identifiable information, credentials, or restricted clinical material.
