...
def render_case(case: dict, skill: str) -> dict[str, str]:
    ...
    files["graders/expect.md"] = (
        ...
        "judge substance, not formatting). Product facts the response verified from a cited source "
        "may be newer than your own knowledge: do not fail it because a model name, price or date "
        "is unfamiliar to you; judge only the listed behaviors.\n\n"
        f"{points}\n\n"
